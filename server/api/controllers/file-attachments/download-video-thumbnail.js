...
const FILE_NAMES = ['frame-0-360', 'frame-0-720'];
...
module.exports = {
  ...
  async fn(inputs, exits) {
    ...
    const filePath = `${sails.config.custom.attachmentsPathSegment}/${attachment.data.fileReferenceId}/video-thumbnails/${inputs.fileName}.${inputs.fileExtension}`;
    ...
    this.res.type(inputs.fileExtension);
    this.res.set('Cache-Control', 'private, max-age=900'); // 15 minutes
