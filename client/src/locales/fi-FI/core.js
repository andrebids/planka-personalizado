  ...
  translation: {
    common: {
      ...
      areYouSureYouWantToDeactivateThisUser:
        'Haluatko varmasti poistaa tämän käyttäjän käytöstä?',
      areYouSureYouWantToDeleteThisAttachment:
        'Haluatko varmasti poistaa tämän liitteen?',
      areYouSureYouWantToDeleteThisBackgroundImage:
        'Haluatko varmasti poistaa tämän taustakuvan?',
      ...
      areYouSureYouWantToDeleteThisCardForever:
        'Haluatko varmasti poistaa tämän kortin pysyvästi?',
      ...
      areYouSureYouWantToDeleteThisLabel:
        'Haluatko varmasti poistaa tämän tunnisteen?',
      ...
      areYouSureYouWantToDeleteThisTaskList:
        'Haluatko varmasti poistaa tämän tehtävälistan?',
      ...
      areYouSureYouWantToMakeThisProjectShared:
        'Haluatko varmasti jakaa tämän projektin?',
      ...
      cardsOnThisListAreReadyToBeWorkedOn:
        'Tämän listan kortit ovat valmiita työstettäväksi.',
      clickHereOrRefreshPageToUpdate:
        '<0>Päivitä tästä</0> tai lataa sivu uudelleen.',
      closed: 'Suljettu',
      color: 'Väri',
      comments: 'Kommentit',
      contentExceedsLimit: 'Sisältö ylittää rajan {{limit}}',
      contentOfThisAttachmentIsTooBigToDisplay:
        'Liitteen sisältö on liian suuri näytettäväksi.',
      copy_inline: 'kopioi',
      ...
      createNewOneOrSelectExistingOne:
        'Luo uusi tai valitse<br />olemassa oleva.',
      ...
      dynamicAndUnevenlySpacedLayout:
        'Dynaaminen ja epätasaisesti jaettu asettelu.',
      ...
      hideFromProjectListAndFavorites:
        'Piilota projektilistasta ja suosikeista',
      hours: 'Tunnit',
      ...
      taskAssignmentAndProjectCompletion:
        'Tehtävien jako ja projektin valmistuminen.',
      taskListActions_title: 'Tehtävälistan toiminnot',
      taskList_title: 'Tehtävälista',
      team: 'Tiimi',
      thereIsNoPreviewAvailableForThisAttachment:
        'Tälle liitteelle ei ole esikatselua saatavilla.',
      time: 'Aika',
      title: 'Otsikko',
      trash: 'Roskakori',
      ...
      userAddedCardToList:
        '<0>{{user}}</0> lisäsi <2>{{card}}</2> listaan {{list}}',
      userAddedThisCardToList:
        '<0>{{user}}</0> lisäsi tämän kortin listaan {{list}}',
      userAddedUserToCard:
      ...
      userCompletedTaskOnThisCard:
        '<0>{{user}}</0> suoritti tehtävän {{task}} tässä kortissa',
      ...
      viewer: 'Katselija',
      viewers: 'Katselijat',
      visualTaskManagementWithLists:
        'Visuaalinen tehtävien hallinta listoilla.',
