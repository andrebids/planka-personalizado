  ...
  translation: {
    common: {
      ...
      areYouSureYouWantToArchiveCards:
        'Вы уверены, что хотите архивировать карточки?',
      areYouSureYouWantToArchiveThisCard:
        'Вы уверены, что хотите архивировать эту карточку?',
      ...
      areYouSureYouWantToMakeThisProjectShared:
        'Вы уверены, что хотите сделать этот проект общим?',
      ...
      cardsOnThisListAreReadyToBeWorkedOn:
        'Карточки в этом списке готовы к работе.',
      clickHereOrRefreshPageToUpdate:
        '<0>Нажмите здесь</0> или обновите страницу для обновления.',
      closed: 'Закрыто',
      color: 'Цвет',
      ...
      dynamicAndUnevenlySpacedLayout:
        'Динамичное и неравномерно распределённое расположение',
      ...
      selectListToRestoreThisCard:
        'Выберите список для восстановления этой карточки',
      ...
      subscribeToCardWhenCommenting:
        'Подписаться на карточку при комментировании',
      ...
      taskAssignmentAndProjectCompletion:
        'Назначение задач и завершение проекта',
      ...
      userAddedThisCardToList:
        '<0>{{user}}</0> добавил(а) эту карточку в {{list}}',
      ...
      visualTaskManagementWithLists:
        'Визуальное управление задачами с помощью списков',
