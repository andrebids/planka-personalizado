...
export default {
  ...
  translation: {
    common: {
      ...
      areYouSureYouWantToDeleteThisBackgroundImage: 'Tem certeza de que deseja excluir esta imagem de fundo?',
      ...
      areYouSureYouWantToDeleteThisCardForever: 'Tem certeza de que deseja excluir este cartão permanentemente?',
      areYouSureYouWantToDeleteThisComment: 'Tem certeza de que deseja excluir este comentário?',
      areYouSureYouWantToDeleteThisCustomField: 'Tem certeza de que deseja excluir este campo personalizado?',
      areYouSureYouWantToDeleteThisCustomFieldGroup: 'Tem certeza de que deseja excluir este grupo de campos personalizados?',
      ...
      areYouSureYouWantToDeleteThisNotificationService: 'Tem certeza de que deseja excluir este serviço de notificação?',
      ...
      areYouSureYouWantToDeleteThisTaskList: 'Tem certeza de que deseja excluir esta lista de tarefas?',
      ...
      areYouSureYouWantToMakeThisProjectShared: 'Tem certeza de que deseja tornar este projeto partilhado?',
      ...
      cardsOnThisListAreReadyToBeWorkedOn: 'Os cartões nesta lista estão prontos para serem trabalhados.',
      ...
      contentOfThisAttachmentIsTooBigToDisplay: 'O conteúdo deste anexo é demasiado grande para ser exibido.',
      copy_inline: 'copiar',
      ...
      userAddedCardToList: '<0>{{user}}</0> adicionou <2>{{card}}</2> a {{list}}',
      ...
      userCompletedTaskOnCard: '<0>{{user}}</0> completou a tarefa <2>{{task}}</2> em <4>{{card}}</4>',
      userCompletedTaskOnThisCard: '<0>{{user}}</0> completou a tarefa <2>{{task}}</2> neste cartão',
      ...
      userMarkedTaskIncompleteOnThisCard: '<0>{{user}}</0> marcou a tarefa <2>{{task}}</2> como incompleta neste cartão',
      userCreatedTaskOnCard: '<0>{{user}}</0> criou a tarefa <2>{{task}}</2> em <4>{{card}}</4>',
      userCreatedTaskOnThisCard: '<0>{{user}}</0> criou a tarefa <2>{{task}}</2> neste cartão',
      userDeletedTaskOnCard: '<0>{{user}}</0> excluiu a tarefa <2>{{task}}</2> de <4>{{card}}</4>',
      userDeletedTaskOnThisCard: '<0>{{user}}</0> excluiu a tarefa <2>{{task}}</2> deste cartão',
      userUpdatedTaskOnCard: '<0>{{user}}</0> atualizou a tarefa <2>{{task}}</2> em <4>{{card}}</4>',
      userUpdatedTaskOnThisCard: '<0>{{user}}</0> atualizou a tarefa <2>{{task}}</2> neste cartão',
      userCreatedTaskListOnCard: '<0>{{user}}</0> criou lista de tarefas <2>{{taskList}}</2> em <4>{{card}}</4>',
      userCreatedTaskListOnThisCard: '<0>{{user}}</0> criou lista de tarefas <2>{{taskList}}</2> neste cartão',
      userDeletedTaskListOnCard: '<0>{{user}}</0> excluiu lista de tarefas <2>{{taskList}}</2> de <4>{{card}}</4>',
      userDeletedTaskListOnThisCard: '<0>{{user}}</0> excluiu lista de tarefas <2>{{taskList}}</2> deste cartão',
      userCreatedAttachmentOnCard: '<0>{{user}}</0> criou anexo <2>{{attachment}}</2> em <4>{{card}}</4>',
      userCreatedAttachmentOnThisCard: '<0>{{user}}</0> criou anexo <2>{{attachment}}</2> neste cartão',
      userDeletedAttachmentOnCard: '<0>{{user}}</0> excluiu anexo <2>{{attachment}}</2> de <4>{{card}}</4>',
      userDeletedAttachmentOnThisCard: '<0>{{user}}</0> excluiu anexo <2>{{attachment}}</2> deste cartão',
      ...
      userRemovedUserFromThisCard: '<0>{{actorUser}}</0> removeu {{removedUser}} deste cartão',
             userSetDueDateToCard: '<0>{{user}}</0> definiu data limite para <2>{{date}}</2> em <4>{{card}}</4>',
             userRemovedDueDateFromCard: '<0>{{user}}</0> removeu data limite de <2>{{card}}</2>',
             userChangedDueDateOfCard: '<0>{{user}}</0> alterou data limite de <2>{{oldDate}}</2> para <4>{{newDate}}</4> em <6>{{card}}</6>',
      activityLogMessage: '<0>{{user}}</0> realizou uma ação em <2>{{card}}</2>',
