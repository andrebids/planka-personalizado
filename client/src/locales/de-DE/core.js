  ...
  translation: {
    common: {
      ...
      areYouSureYouWantToEmptyTrash:
        'Sind Sie sicher, dass Sie den Papierkorb leeren möchten?',
      ...
      canBeInvitedToWorkInBoards:
        'Kann zu Projekten und Boards eingeladen werden.',
      ...
      cardsOnThisListAreReadyToBeWorkedOn:
        'Karten in dieser Liste sind bereit zur Bearbeitung.',
      ...
      dynamicAndUnevenlySpacedLayout:
        'Dynamisches und ungleichmäßig verteiltes Layout.',
      ...
      hideFromProjectListAndFavorites:
        'Aus Projektliste und Favoriten ausblenden',
      hours: 'Stunden',
      ...
      selectListToRestoreThisCard:
        'Liste auswählen, um diese Karte wiederherzustellen',
      ...
      taskAssignmentAndProjectCompletion:
        'Verwaltung von Aufgaben und Projekten.',
      ...
      userAddedThisCardToList:
        '<0>{{user}}</0> hat diese Karte hinzugefügt zu {{list}}',
