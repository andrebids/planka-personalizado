  ...
  translation: {
    common: {
      ...
      areYouSureYouWantToArchiveCards:
        'Sei sicuro di voler archiviare le schede?',
      areYouSureYouWantToArchiveThisCard:
        'Sei sicuro di voler archiviare questa scheda?',
      ...
      areYouSureYouWantToDeleteThisTaskList:
        'Sei sicuro di voler eliminare questa lista di task?',
      ...
      clickHereOrRefreshPageToUpdate:
        '<0>Clicca qui</0> o ricarica la pagina per aggiornare.',
      closed: 'Chiuso',
      color: 'Colore',
      comments: 'Commenti',
      ...
      createNewOneOrSelectExistingOne:
        'Crea nuovo o seleziona uno<br />esistente.',
      ...
      dynamicAndUnevenlySpacedLayout:
        'Layout dinamico e irregolarmente distribuito',
      ...
      hideFromProjectListAndFavorites:
        'Nascondi dalla lista dei progetti e dai preferiti',
      hours: 'Ore',
      ...
      limitCardTypesToDefaultOne:
        'Limita i tipi di scheda a quello predefinito',
      list: 'Lista',
      ...
      referenceDataAndKnowledgeStorage:
        'Dati di riferimento e di archiviazione',
      ...
      selectListToRestoreThisCard:
        'Seleziona lista per ripristinare questa scheda',
      ...
      subscribeToMyOwnCardsByDefault:
        'Abbonati alle mie scheda per impostazione predefinita',
      taskActions_title: 'Azioni task',
      taskAssignmentAndProjectCompletion:
        'Assegnazione di task e completamento del progetto',
      ...
      title: 'Titolo',
      trash: 'Cestino',
      trashHasBeenSuccessfullyEmptied:
        'Il cestino è stato svuotato con successo.',
      turnOffRecentCardHighlighting:
        "Disattiva l'evidenziazione delle scheda recenti",
      ...
      userAddedCardToList:
        '<0>{{user}}</0> ha aggiunto <2>{{card}}</2> a {{list}}',
      userAddedThisCardToList:
        '<0>{{user}}</0> ha aggiunto questa task a {{list}}',
      userAddedUserToCard:
        '<0>{{actorUser}}</0> ha aggiunto {{addedUser}} a <4>{{card}}</4>',
      ...
      userCompletedTaskOnThisCard:
        '<0>{{user}}</0> ha completato {{task}} in questa task',
      ...
      userRemovedUserFromCard:
        '<0>{{actorUser}}</0> ha rimosso {{removedUser}} da <4>{{card}}</4>',
      userRemovedUserFromThisCard:
        '<0>{{actorUser}}</0> ha rimosso {{removedUser}} da questa task',
      username: 'Username',
      users: 'Utenti',
