  ...
  translation: {
    common: {
      ...
      areYouSureYouWantToArchiveCards:
        '¿Estás seguro de que quieres archivar las tarjetas?',
      areYouSureYouWantToArchiveThisCard:
        '¿Estás seguro de que quieres archivar esta tarjeta?',
      ...
      areYouSureYouWantToLeaveBoard:
        '¿Estás seguro de que quieres abandonar el tablero?',
      areYouSureYouWantToLeaveProject:
        '¿Estás seguro de que quieres abandonar el proyecto?',
      ...
      clickHereOrRefreshPageToUpdate:
        '<0>Haz clic aquí</0> o actualiza la página para actualizar.',
      closed: 'Cerrado',
      color: 'Color',
      ...
      dynamicAndUnevenlySpacedLayout:
        'Diseño dinámico y espaciado irregularmente',
      ...
      hideFromProjectListAndFavorites:
        'Ocultar de la lista de proyectos y favoritos',
      hours: 'Horas',
      ...
      limitCardTypesToDefaultOne:
        'Limitar los tipos de tarjeta al predeterminado',
      list: 'Lista',
      ...
      referenceDataAndKnowledgeStorage:
        'Datos de referencia y almacenamiento de conocimiento',
      ...
      selectListToRestoreThisCard:
        'Seleccionar lista para restaurar esta tarjeta',
      ...
      taskAssignmentAndProjectCompletion:
        'Asignación de tareas y finalización del proyecto',
      ...
      trashHasBeenSuccessfullyEmptied:
        'La papelera se ha vaciado correctamente.',
      turnOffRecentCardHighlighting:
        'Desactivar el resaltado de tarjetas recientes',
      ...
      userAddedThisCardToList:
        '<0>{{user}}</0> añadido a esta tarjeta en {{list}}',
      userAddedUserToCard:
        '<0>{{actorUser}}</0> añadió {{addedUser}} a <4>{{card}}</4>',
      ...
      userCompletedTaskOnThisCard:
        '<0>{{user}}</0> completó {{task}} en esta tarjeta',
      ...
      userRemovedUserFromCard:
        '<0>{{actorUser}}</0> eliminó a {{removedUser}} de <4>{{card}}</4>',
      userRemovedUserFromThisCard:
        '<0>{{actorUser}}</0> eliminó a {{removedUser}} de esta tarjeta',
