  ...
  translation: {
    common: {
      ...
      areYouSureYouWantToActivateThisUser:
        'Jesteś pewien że chcesz aktywować tego użytkownika?',
      areYouSureYouWantToArchiveCards:
        'Jesteś pewien że chcesz archiwizować karty?',
      areYouSureYouWantToArchiveThisCard:
        'Jesteś pewien że chcesz archiwizować tę kartę?',
      ...
      areYouSureYouWantToLeaveProject:
        'Jesteś pewien że chcesz opuścić projekt?',
      ...
      canBeInvitedToWorkInBoards:
        'Może być zaproszony do pracy przy tablicach.',
      ...
      cardsOnThisListAreReadyToBeWorkedOn:
        'Karty na tej liście są gotowe do pracy nad nimi.',
      clickHereOrRefreshPageToUpdate:
        '<0>Naciśnij tutaj</0> lub odśwież stronę, by zaktualizować.',
      closed: 'Zamknięte',
      color: 'Kolor',
      comments: 'Komentarze',
      ...
      createNewOneOrSelectExistingOne:
        'Stwórz nowe lub wybierz<br />istniejące.',
      ...
      referenceDataAndKnowledgeStorage:
        'Odnoś się do danych i przechowuj wiedzę',
      ...
      selectListToRestoreThisCard:
        'Wybierz listę, na którą ma być przywrócona ta karta',
      ...
      taskAssignmentAndProjectCompletion:
        'Przypisanie zadań i stopień ukończenia projektów.',
      ...
      userAddedUserToCard:
        '<0>{{actorUser}}</0> dodał {{addedUser}} do <4>{{card}}</4>',
      ...
      userCompletedTaskOnThisCard:
        '<0>{{user}}</0> oznaczył {{task}} jako ukończone na tej karcie',
      ...
      userRemovedUserFromCard:
        '<0>{{actorUser}}</0> usunął {{removedUser}} z <4>{{card}}</4>',
      userRemovedUserFromThisCard:
        '<0>{{actorUser}}</0> usunął {{removedUser}} z tej karty',
      username: 'Nazwa Użytkownika',
      users: 'Użytkownicy',
      viewer: 'Wyświetlający',
      viewers: 'Wyświetlający',
      visualTaskManagementWithLists:
        'Wizualne zarządzanie zadaniami z listami.',
