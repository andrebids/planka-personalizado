  ...
  translation: {
    common: {
      ...
      areYouSureYouWantToArchiveCards:
        'Er du sikker på, at du vil arkivere kort?',
      areYouSureYouWantToArchiveThisCard:
        'Er du sikker på, at du vil arkivere dette kort?',
      ...
      areYouSureYouWantToDeleteThisBoard:
        'Er du sikker på at du vil slette denne tavle?',
      areYouSureYouWantToDeleteThisCard:
        'Er du sikker på at du vil slette dette kort?',
      ...
      areYouSureYouWantToDeleteThisLabel:
        'Er du sikker på at du vil slette denne label?',
      ...
      areYouSureYouWantToDeleteThisTaskList:
        'Er du sikker på at du vil slette denne opgaveliste?',
      ...
      areYouSureYouWantToLeaveBoard:
        'Er du sikker på at du vil forlade denne tavle?',
      areYouSureYouWantToLeaveProject:
        'Er du sikker på at du vil forlade dette projekt?',
      ...
      cardsOnThisListAreReadyToBeWorkedOn:
        'Kort på denne liste er klar til at blive arbejdet på.',
      clickHereOrRefreshPageToUpdate:
        '<0>Klik her</0> eller opdater siden for at opdatere.',
      closed: 'Lukket',
      color: 'Farve',
      ...
      createNewOneOrSelectExistingOne:
        'Lav en ny eller vælg<br />en eksisterende.',
      ...
      taskAssignmentAndProjectCompletion:
        'Opgave tildeling og projekt færdiggørelse',
      ...
      userAddedCardToList:
        '<0>{{user}}</0> tilføjede <2>{{card}}</2> til {{list}}',
      userAddedThisCardToList: '<0>{{user}}</0> tilføjede kortet til {{list}}',
      userAddedUserToCard:
        '<0>{{actorUser}}</0> tilføjede {{addedUser}} til <4>{{card}}</4>',
      ...
      userCompletedTaskOnThisCard:
        '<0>{{user}}</0> færdiggjorte {{task}} på dette kort',
      ...
      userRemovedUserFromCard:
        '<0>{{actorUser}}</0> fjernede {{removedUser}} fra <4>{{card}}</4>',
      userRemovedUserFromThisCard:
        '<0>{{actorUser}}</0> fjernede {{removedUser}} fra dette kort',
      username: 'Brugernavn',
      users: 'Brugere',
      viewer: 'Læser',
      viewers: 'Læsere',
