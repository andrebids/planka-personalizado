  ...
  translation: {
    common: {
      ...
      areYouSureYouWantToArchiveThisCard:
        'Opravdu chcete archivovat tuto kartu?',
      ...
      areYouSureYouWantToDeleteThisBoard:
        'Opravdu chcete smazat tuto nástěnku?',
      ...
      areYouSureYouWantToDeleteThisTaskList:
        'Opravdu chcete tento seznam úkolů odstranit?',
      ...
      cardsOnThisListAreReadyToBeWorkedOn:
        'Karty na tomto seznamu jsou připraveny k práci.',
      clickHereOrRefreshPageToUpdate:
        '<0>Klikněte sem</0> nebo aktualizujte stránku.',
      closed: 'Uzavřeno',
      color: 'Barva',
      comments: 'Komentáře',
      ...
      createNewOneOrSelectExistingOne:
        'Vytvořit nový nebo vybrat<br />již existující.',
      ...
      hideFromProjectListAndFavorites:
        'Skrýt ze seznamu projektů a oblíbených položek',
      hours: 'Hodiny',
      ...
      referenceDataAndKnowledgeStorage:
        'Uchovávání referenčních údajů a znalostí.',
