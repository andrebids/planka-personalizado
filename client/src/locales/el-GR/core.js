  ...
  translation: {
    common: {
      ...
      areYouSureYouWantToArchiveCards:
        'Είστε σίγουροι ότι θέλετε να αρχειοθετήσετε τις κάρτες;',
      ...
      areYouSureYouWantToDeleteThisCard:
        'Είστε σίγουροι ότι θέλετε να διαγράψετε αυτήν την κάρτα;',
      ...
      areYouSureYouWantToEmptyTrash:
        'Είστε σίγουροι ότι θέλετε να αδειάσετε τον κάδο;',
      areYouSureYouWantToLeaveBoard:
        'Είστε σίγουροι ότι θέλετε να αποχωρήσετε από τον πίνακα;',
      ...
      canBeInvitedToWorkInBoards:
        'Μπορεί να προσκληθεί να εργαστεί σε πίνακες.',
      ...
      clickHereOrRefreshPageToUpdate:
        '<0>Κάντε κλικ εδώ</0> ή ανανεώστε τη σελίδα για ενημέρωση.',
      closed: 'Κλειστό',
      color: 'Χρώμα',
      comments: 'Σχόλια',
      ...
      createNewOneOrSelectExistingOne:
        'Δημιουργήστε νέο ή επιλέξτε<br />υπάρχον.',
      ...
      dynamicAndUnevenlySpacedLayout:
        'Δυναμική και άνισα κατανεμημένη διάταξη.',
      ...
      hideFromProjectListAndFavorites:
        'Απόκρυψη από τη λίστα έργων και τα αγαπημένα',
      hours: 'Ώρες',
      ...
      referenceDataAndKnowledgeStorage:
        'Αποθήκευση δεδομένων και γνώσης αναφοράς.',
      ...
      selectListToRestoreThisCard:
        'Επιλέξτε λίστα για επαναφορά αυτής της κάρτας',
      ...
      taskAssignmentAndProjectCompletion:
        'Ανάθεση εργασίας και ολοκλήρωση έργου.',
      ...
      turnOffRecentCardHighlighting:
        'Απενεργοποίηση επισήμανσης πρόσφατων καρτών',
      ...
      userAddedCardToList:
        '<0>{{user}}</0> πρόσθεσε <2>{{card}}</2> στη λίστα {{list}}',
      userAddedThisCardToList:
        '<0>{{user}}</0> πρόσθεσε αυτήν την κάρτα στη λίστα {{list}}',
      userAddedUserToCard:
