  ...
  translation: {
    common: {
      ...
      areYouSureYouWantToActivateThisUser:
        'Ви впевнені, що хочете активувати цього користувача?',
      areYouSureYouWantToArchiveCards:
        'Ви впевнені, що хочете архівувати картки?',
      areYouSureYouWantToArchiveThisCard:
        'Ви впевнені, що хочете заархівувати цю картку?',
      ...
      areYouSureYouWantToDeleteThisTaskList:
        'Ви впевнені, що хочете видалити цей список завдань?',
      ...
      cardsOnThisListAreReadyToBeWorkedOn:
        'Картки з цього списку готові до роботи.',
      clickHereOrRefreshPageToUpdate:
        '<0>Натисніть тут</0> або оновіть сторінку для оновлення.',
      closed: 'Закрито',
      color: 'Колір',
      comments: 'Коментарі',
      ...
      hideFromProjectListAndFavorites:
        'Приховати зі списку проектів та обраного',
      hours: 'Години',
      ...
      limitCardTypesToDefaultOne:
        'Обмежте типи карток до одного за замовчуванням',
      list: 'Список',
      ...
      selectListToRestoreThisCard:
        'Виберіть список для відновлення цієї картки',
      ...
      taskAssignmentAndProjectCompletion:
        'Постановка завдань і завершення проекту.',
      ...
      userAddedThisCardToList:
        '<0>{{user}}</0> додав(ла) цю картку до {{list}}',
      ...
      visualTaskManagementWithLists:
        'Візуальне управління завданнями за допомогою списків.',
