...
export default {
  ...
  SIDEBAR_EXPANDED_SET: 'SIDEBAR_EXPANDED_SET',
  TIMELINE_PANEL_TOGGLE: 'TIMELINE_PANEL_TOGGLE',
  TIMELINE_PANEL_SET_EXPANDED: 'TIMELINE_PANEL_SET_EXPANDED',
  LOGOUT: 'LOGOUT',
  ...
  FAVORITES_ORDER_SAVE: 'FAVORITES_ORDER_SAVE',
  FAVORITES_ORDER_LOAD: 'FAVORITES_ORDER_LOAD',
  FAVORITES_ORDER_RESET: 'FAVORITES_ORDER_RESET',
  ...
  BASE_CUSTOM_FIELD_GROUP_CREATE__SUCCESS:
    'BASE_CUSTOM_FIELD_GROUP_CREATE__SUCCESS',
  BASE_CUSTOM_FIELD_GROUP_CREATE__FAILURE:
    'BASE_CUSTOM_FIELD_GROUP_CREATE__FAILURE',
  BASE_CUSTOM_FIELD_GROUP_CREATE_HANDLE:
    'BASE_CUSTOM_FIELD_GROUP_CREATE_HANDLE',
  BASE_CUSTOM_FIELD_GROUP_UPDATE: 'BASE_CUSTOM_FIELD_GROUP_UPDATE',
  BASE_CUSTOM_FIELD_GROUP_UPDATE__SUCCESS:
    'BASE_CUSTOM_FIELD_GROUP_UPDATE__SUCCESS',
  BASE_CUSTOM_FIELD_GROUP_UPDATE__FAILURE:
    'BASE_CUSTOM_FIELD_GROUP_UPDATE__FAILURE',
  ...
  BASE_CUSTOM_FIELD_GROUP_DELETE__SUCCESS:
    'BASE_CUSTOM_FIELD_GROUP_DELETE__SUCCESS',
  BASE_CUSTOM_FIELD_GROUP_DELETE__FAILURE:
    'BASE_CUSTOM_FIELD_GROUP_DELETE__FAILURE',
