...
export default function* attachmentsWatchers() {
  yield all([
    ...
    takeEvery(
      EntryActionTypes.ATTACHMENT_CREATE_HANDLE,
      ({ payload: { attachment, requestId } }) =>
    ...
    takeEvery(
      EntryActionTypes.ATTACHMENT_UPDATE_HANDLE,
      ({ payload: { attachment } }) =>
    ...
    takeEvery(
      EntryActionTypes.ATTACHMENT_DELETE_HANDLE,
      ({ payload: { attachment } }) =>
