...
export default function* notificationsWatchers() {
  yield all([
    takeEvery(EntryActionTypes.ALL_NOTIFICATIONS_DELETE, () =>
      services.deleteAllNotifications()
    ),
    takeEvery(
      EntryActionTypes.NOTIFICATION_CREATE_HANDLE,
    ...
    takeEvery(
      EntryActionTypes.NOTIFICATION_DELETE_HANDLE,
